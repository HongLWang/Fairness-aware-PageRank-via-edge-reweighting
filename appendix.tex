...
\label{eq:gradient_fairness_loss_group_adapted}
    \frac{\partial}{\partial \transmatrix} \loss(\transmatrix, \gamma, \vectv) 
        & = \frac{\partial}{\partial \transmatrix} \frac{1}{K}
                \sum_{k=1}^{\nogroups} \left(\indvect{\agroup}^{\mathsf{T}} \prvector_l - \grouppr_\agroup\right)^2 \\
        & = \frac{2}{K} \sum_{k=1}^{\nogroups} \left(\indvect{\agroup}^{\mathsf{T}} \prvector_l - \grouppr_\agroup\right) 
                \frac{\partial}{\partial \transmatrix} \left(\indvect{\agroup}^{\mathsf{T}} \prvector_l - \grouppr_\agroup\right) \\
        & = \frac{2}{\nogroups^2} \sum_{k=1}^{\nogroups} \left(\indvect{\agroup}^{\mathsf{T}} \prvector_l - \grouppr_\agroup\right) 
                \frac{\partial}{\partial \transmatrix} \left(\indvect{\agroup}^{\mathsf{T}} \prvector_l \right)  \\ 
        & = \frac{2 \gamma}{K} \sum_{k=1}^{\nogroups} \left(\indvect{\agroup}^{\mathsf{T}} \prvector_l - \grouppr_\agroup\right) 
                \frac{\partial}{\partial \transmatrix} \left(\indvect{\agroup}^{\mathsf{T}} \matrixU^{-1} \vectv_l \right). 
\end{aligned}
\end{equation}
...
\begin{aligned}
\frac{\partial}{\partial \transmatrix[i, j]} \left(\indvect{\agroup}^{\mathsf{T}} \matrixU^{-1} \vectv_l \right) 
    & = (1 - \gamma) \left( \matrixU^{-1} \vectv_l \indvect{\agroup}^{\mathsf{T}} \matrixU^{-1} \right)[i, j] \\
    & = \frac{1 - \gamma}{\gamma} \left( \prvector_l \indvect{\agroup}^{\mathsf{T}} \matrixU^{-1} \right)[i, j].
\end{aligned}
\end{equation}
...
\begin{equation*}
    \textbf{S}_k = \sum_{t=0}^k \textbf{X}^{\mathsf{T}} = \textbf{I} + \textbf{X} + \textbf{X}^2 + \dots + \textbf{X}^k.
\end{equation*}
...
\begin{equation*}
    \textbf{E}_k = \sum_{t=k+1}^\infty \textbf{X}^{\mathsf{T}}
\end{equation*}
By factoring out $\textbf{X}^{k+1}$ from the series we get:
\begin{equation*}
    \textbf{E}_k = \textbf{X}^{k+1} \sum_{t=0}^\infty \textbf{X}^{\mathsf{T}}.
\end{equation*}
...
\end{equation*}
where $g_k(\transmatrix) = \indvect{\agroup}^{\mathsf{T}} \prvector - \phi_k$ and $\prvector = \gamma (I - (1-\gamma) \transmatrix^{\mathsf{T}})^{-1} \vectv.$
...
Let \(\Amatrix = I - (1-\gamma) \transmatrix^{\mathsf{T}}\), then it holds that, $\Amatrix \prvector = \gamma \vectv$, and 
\begin{equation*}
...
where
\begin{align*}
    \frac{\partial \Amatrix}{\partial \transmatrix_{ij}} &= \frac{\partial I - (1 - \gamma)\partial \transmatrix^{\mathsf{T}}}{\partial \transmatrix_{ij}} \\
    & = -(1-\gamma) \frac{\partial \transmatrix^{\mathsf{T}}}{\partial \transmatrix_{ij}} = -(1 - \gamma) \Ematrix_{ji},
\end{align*}
with $\Ematrix_{ji}$ denoting the matrix where only the $(j,i)$-th element is 1, and all other elements are zero. 

Therefore,
\begin{align*}
\frac{\partial h_k}{\partial \transmatrix_{ij}} &= \indvect{\agroup}^{\mathsf{T}} \frac{\partial \prvector}{\partial \transmatrix_{ij}} \\
&= (1-\gamma) \indvect{\agroup}^{\mathsf{T}} \invAmatrix \Ematrix_{ji} \prvector \\
&= (1-\gamma) \prvector_i (\indvect{\agroup}^{\mathsf{T}} \invAmatrix \matr{e}_j)
\end{align*}
...
\[
\frac{\partial g_k}{\partial \transmatrix_{ab}} = \frac{\partial h_k}{\partial \transmatrix_{ab}} = (1-\gamma) \prvector_a (\indvect{\agroup}^{\mathsf{T}} \invAmatrix \matr{e}_b)
\]

\paragraph{Second term:}
\begin{align*}
\frac{\partial^2 h_k}{\partial \transmatrix_{ij} \partial \transmatrix_{ab}}
&= (1-\gamma) \frac{\partial}{\partial \transmatrix_{ab}} \left[ \prvector_i (\indvect{\agroup}^{\mathsf{T}} \invAmatrix \matr{e}_j) \right] \\
&= (1-\gamma) \left[
    \frac{\partial \prvector_i}{\partial \transmatrix_{ab}} (\indvect{\agroup}^{\mathsf{T}} \invAmatrix \matr{e}_j)
    + \prvector_i \frac{\partial}{\partial \transmatrix_{ab}} (\indvect{\agroup}^{\mathsf{T}} \invAmatrix \matr{e}_j)
\right]
\end{align*}
We have:
\[
...
and
\[
\frac{\partial}{\partial \transmatrix_{ab}} (\indvect{\agroup}^{\mathsf{T}} \invAmatrix \matr{e}_j) = (1-\gamma) \indvect{\agroup}^{\mathsf{T}} \invAmatrix \Ematrix_{ba} \invAmatrix \matr{e}_j
\]
{Combining the two terms, we get}
\begin{align*}
\frac{\partial^2 h_k}{\partial \transmatrix_{ij} \partial \transmatrix_{ab}} &=
(1-\gamma)^2 \Big(
    [\invAmatrix \Ematrix_{ba} \prvector]_i \cdot (\indvect{\agroup}^{\mathsf{T}} \invAmatrix \matr{e}_j)
    + \prvector_i \cdot \indvect{\agroup}^{\mathsf{T}} \invAmatrix \Ematrix_{ba} \invAmatrix \matr{e}_j
\Big)
\end{align*}
...
= \frac{2}{K} \sum_{k=1}^K \Bigg[
        (1-\gamma)^2 \prvector_a \prvector_i (\indvect{\agroup}^{\mathsf{T}} \invAmatrix \matr{e}_b)(\indvect{\agroup}^{\mathsf{T}} \invAmatrix \matr{e}_j)\\ \nonumber
...
\label{eq:hessian}
     \Hmatrix_{rs}
&= \frac{2}{K} \sum_{k=1}^K \Bigg[
        (1-\gamma)^2 \prvector_{a(s)} \prvector_{i(r)}(\indvect{\agroup}^{\mathsf{T}} \invAmatrix \matr{e}_{b(s)})(\indvect{\agroup}^{\mathsf{T}} \invAmatrix \matr{e}_{j(r)})\\ \nonumber
    &+\ g_k(\transmatrix) \cdot (1-\gamma)^2 \Big(
        [\invAmatrix \Ematrix_{b(s)a(s)} \prvector]_{i(r)} \cdot (\indvect{\agroup}^{\mathsf{T}} \invAmatrix \matr{e}_{j(r)} \\ \nonumber 
        &+ \ g_k(\transmatrix) \cdot (1-\gamma)^2 \prvector_{i(r)} \cdot \indvect{\agroup}^{\mathsf{T}} \invAmatrix \Ematrix_{b(s)a(s)} \invAmatrix \matr{e}_{j(r)}
    \Big)
\Bigg]
\end{align*}
Let 
\begin{align*}
    \Hmatrix_{rs}^{(1)} & = \frac{2}{K} (1-\gamma)^2\sum_{k=1}^K 
         \prvector_{a(s)} \prvector_{i(r)}(\indvect{\agroup}^{\mathsf{T}} \invAmatrix \matr{e}_{b(s)})(\indvect{\agroup}^{\mathsf{T}} \invAmatrix \matr{e}_{j(r)}) \\
        \Hmatrix_{rs}^{(2)} & = \frac{2}{K} (1-\gamma)^2\sum_{k=1}^K 
        \ g_k(\transmatrix) 
        [\invAmatrix \Ematrix_{b(s)a(s)} \prvector]_{i(r)} \cdot (\indvect{\agroup}^{\mathsf{T}} \invAmatrix \matr{e}_{j(r)}) \\    
        \Hmatrix_{rs}^{(3)} & = \frac{2}{K} (1-\gamma)^2\sum_{k=1}^K 
        \ g_k(\transmatrix)  \prvector_{i(r)} \cdot \indvect{\agroup}^{\mathsf{T}} \invAmatrix \Ematrix_{b(s)a(s)} \invAmatrix \matr{e}_{j(r)} 
\end{align*}
Then it holds that
\begin{equation*}
...
Before bounding the operator norm of each term, we first proof $\|\invAmatrix\|_2 \leq 1/\gamma$, which will be used multiple times in the following deriviation.
 The proof is the result of three observations: (1) the largest eigenvalue of $P^{\mathsf{T}}$ is 1, (2) the smallest eigenvalue of $\Amatrix$ is $\gamma$ and (3) the operator norm of the symmetric matrix $\|\invAmatrix\|_2$ is the reciprocal of the smallest absolute eigenvalue of $\Amatrix$. We provide details for each observation in the following:
\begin{enumerate}
	\item Let $\textbf{1}$ be an all-one vector, i.e. $\textbf{1} = (1,1,...,1)^{\mathsf{T}}$. We can see $\textbf{1}$ is a eigenvector of $\transmatrix$ since $\transmatrix \textbf{1} = 1$. We also know the largest eigenvalue is bounded by the infinity norm, which is $\| \transmatrix\|_{\infty} = \max_i \sum_{j}|\transmatrix_{ij}| = 1$. Thus, the maximum eigenvalue of $P^{\mathsf{T}}$, which is equal to the maximum eigenvalue of $P$, is equal to 1.
	
	\item Let $\lambda$ denote each eigenvalue of $\transmatrix^{\mathsf{T}}$, and $\mu$ each eigenvalue of $\Amatrix$. Since $\Amatrix = I - (1 - \gamma) \transmatrix^{\mathsf{T}}$, it holds that $\mu = 1 - (1 - \gamma) \lambda$. Thus the smallest eigenvalue of $\Amatrix$ occurs when $\lambda = 1$, leading to $u_{min} = 1 - (1 - \gamma) = \gamma$
...
\begin{equation*}
    \vectw_k[r] = (1 - \gamma) \prvector_{i(r)} (\indvect{k}^{\mathsf{T}} \invAmatrix e_{j(r)})
\end{equation*}
...
\begin{align*}
    \|\vectw_k\|_2^2 &= {(1-\gamma)^2} \sum_{i=1}^{n}\prvector_{i}^2  \sum_{j=1}^{n} (\indvect{k}^{\mathsf{T}} \invAmatrix e_j)^2\\
    & ={(1-\gamma)^2} \sum_{i=1}^{n}\prvector_{i}^2  \|\indvect{k}^{\mathsf{T}} \invAmatrix \|_2^2 \\
...
\begin{align*}
	...
	& \stackrel{(a)}{=} \frac{2(1-\gamma)^2}{K} \sum_{k=1}^{K} g_k \left[ \sum_{a, b} [\invAmatrix \Ematrix_{b a} \prvector]_i \Xmatrix_{a b} \right] (\indvect{k}^{\mathsf{T}} \invAmatrix \vecte_{j})	\\
	&=  \frac{2(1-\gamma)^2}{K} \sum_{k=1}^{K} g_k \left[ \sum_{ b} \left(\invAmatrix \right)_{i,b} \left(\sum_a \prvector_a \Xmatrix_{a,b} \right) \right] (\indvect{k}^{\mathsf{T}} \invAmatrix \vecte_{j})
\end{align*}
...
\begin{equation*}
	\Ymatrix = \frac{2(1-\gamma)^2}{K} (\invAmatrix u) \vectw^{\mathsf{T}}
\end{equation*}
Since  $(\invAmatrix u) \vectw^{\mathsf{T}}$ is a rank-1 matrix, the spectrual norm and the Frobenius norm of $(\invAmatrix u) \vectw^{\mathsf{T}}$ are equal. 
...
\begin{equation*}
	\Hmatrix^{(2)}_{rs} = \frac{2(1-\gamma)^2}{K} \sum_{k=1}^{K} g_k \prvector_{a(s)} (\invAmatrix_{i(r)b(s)})\left(\indvect{k}^{\mathsf{T}} \invAmatrix \vecte_{j(r)}\right)
\end{equation*}

For a fixed $(k,b)$ pair, we can define a vector $\vectx_{k,b} \in \mathbb{R}^{n^2}$ as follow
\begin{equation*}
    \vectx_{k,b}[r] = \sqrt{|g_k|}(1 - \gamma)^2 (\invAmatrix)_{i(r),b}(\indvect{k}^{\mathsf{T}} \invAmatrix \vecte_{j(r)})
\end{equation*}
...
\begin{align*}
	\|\vectx_{k,b}\|_2 &= \sqrt{|g_k|} (1 - \gamma)^2 \|\Amatrix \vecte_b \|_2 \|\indvect{k}^{\mathsf{T}} \invAmatrix\|_2 \\ 
	&\leq \sqrt{|g_k|} (1 - \gamma)^2 ( \|\Amatrix \|_2)^2 \|\indvect{k}^{\mathsf{T}}\|_2 \leq \frac{(1-\gamma)^2\sqrt{|g_k|}}{\gamma^2} \|\indvect{k}^{\mathsf{T}}\|_2
\end{align*}
and
\begin{equation*}
...
\end{equation*}
where $\vectz_k = \indvect{k}^{\mathsf{T}} \invAmatrix$.
...
\iffalse
\begin{equation*}
	\vectalpha_{k,b,j}[r] = (1 - \gamma) \prvector_{i(r)} (\indvect{k}^{\mathsf{T}} \invAmatrix \vecte_b) \matr{1} (j(r) = j)
\end{equation*}
...
\begin{align*}
	\|\vectalpha_{k,b,j}\|_2 &\leq (1-\gamma) \|p\|_2 |\indvect{k}^{\mathsf{T}} \invAmatrix e_b| \matr{1}(j(r) = j) \\
	& \leq (1 - \gamma) |\indvect{k}^{\mathsf{T}} \invAmatrix e_b| \sum_{i=1}^{n} \prvector_i^2 \matr{1}(j(r) = j) \\
...
& = \frac{2}{K^2} \sum_{k=1}^K \sum_{l=1}^K \Bigg[
        (1-\gamma)^2 {\prvector_l}_a {\prvector_l}_i (\indvect{\agroup}^{\mathsf{T}} \invAmatrix \matr{e}_b)(\indvect{\agroup}^{\mathsf{T}} \invAmatrix \matr{e}_j)\\ \nonumber
    &+\ g_k(\transmatrix) \cdot (1-\gamma)^2 \Big(
        [\invAmatrix \Ematrix_{ba} {\prvector_l}]_i \cdot (\indvect{\agroup}^{\mathsf{T}} \invAmatrix \matr{e}_j)
        + {\prvector_l}_i \cdot \indvect{\agroup}^{\mathsf{T}} \invAmatrix \Ematrix_{ba} \invAmatrix \matr{e}_j
    \Big)
\Bigg]
\end{align}
